...
# 적 캐릭터
enemy = pygame.image.load("/Users/kimminjong/Documents/python workspace/work spaceses/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size # 이미지 크기를 구해옴
enemy_width = enemy_size[0]
enemy_height = enemy_size[1]
enemy_x_pos = (screen_width / 2) - (enemy_width / 2)#화면 가로의 절반 크기에 해당하는 위치(가로)
...
running = True 
while running:
    dt = clock.tick(60) #게임화면의 초당 프레임술를 설정 
